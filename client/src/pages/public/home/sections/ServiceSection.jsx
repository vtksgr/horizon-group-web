        ...
        <section className="w-full xl:w-[75%] px-4 sm:px-6 lg:px-8 xl:px-0 mx-auto">
            ...
            <div className="mt-9">
                <div className="mb-9">
                    ...
                    <p className="md:pl-6">私たちは、日本で働きたい外国人と、優秀な人材を求める企業様をつなぐ人材紹介サービスを展開しています。採用から就労まで、すべてのステッ
                        で丁寧かつ的確にサポートいたします。</p>
                </div>

                <div className="p-2 flex flex-col md:flex-row md:items-stretch border border-gray-300 rounded-lg shadow-sm">
                    ...
                    <div className="md:w-7/12 p-4">
                        <h4 className="mb-6 pb-2 border-b border-gray-300">For Company <span className="text-[var(--color-primary)]">企業様向け</span></h4>
                        <p className="mb-4 font-medium">外国籍人材の採用をご検討中の企業様に、以下のサポートを提供します：</p>
                ...
                <div className="p-2 mt-4 flex flex-col md:flex-row md:items-stretch border border-gray-300 rounded-lg shadow-sm">
                    <div className="md:w-5/12 p-4 md:flex">
                        <div className="overflow-hidden rounded-xl shadow-md md:flex-1">
                            <img
                                src={hbBuilding}
                    ...
                    <div className="md:w-7/12 p-4">
                        <h4 className="mb-6 pb-2 border-b border-gray-300">For Job Seekers <span className="text-[var(--color-primary)]">求職者様向け</span></h4>
            ...
            <div className="mt-24">
                ...
                <div className="p-2 flex flex-col md:flex-row md:items-stretch border border-gray-300 rounded-lg shadow-sm">
                    ...
                    <div className="md:w-7/12 p-4">
                        <h4 className="mb-6 pb-2 border-b border-gray-300">For Student <span className="text-[var(--color-primary)]">提供サービス：</span></h4>
                        <ul className="space-y-2">
                        ...
                        <p className="mb-4 font-medium">留学生の皆様が安心して学び、成長できる環境づくりをお手伝いいたします。</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-24">
                ...
                <div className="p-2 flex flex-col md:flex-row md:items-stretch border border-gray-300 rounded-lg shadow-sm">
                    ...
                    <div className="md:w-7/12 p-4">
                        <h4 className="mb-6 pb-2 border-b border-gray-300">Language Support <span className="text-[var(--color-primary)]">対応言語：</span></h4>
